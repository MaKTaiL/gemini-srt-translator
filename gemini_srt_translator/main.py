...
class GeminiSRTTranslator:
    ...
    def translate(self):
        ...
        instruction = f"You are a professional subtitle translator. Translate the following subtitles to {self.target_language}. Keep the same meaning and tone. Return the translation in a JSON array with the same format as the input."
        if self.description:
